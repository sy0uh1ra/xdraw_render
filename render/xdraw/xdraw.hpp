...
namespace xdraw {
	...
	[[nodiscard]] font* load_system_font( std::string_view name, float size_px, int weight = 400, int quality = 0, int atlas_w = 1024, int atlas_h = 1024 );

	namespace font_quality
	{
		constexpr int default_quality = 0;
		constexpr int nonantialiased = 3;
		constexpr int antialiased = 4;
		constexpr int cleartype = 5;
		constexpr int cleartype_natural = 6;
	}
...
namespace tokens {
	...
	inline xdraw::color col_accent{184, 173, 255, 255};
	constexpr xdraw::color col_dark{ 17, 17, 17, 255 };
	constexpr xdraw::color col_text{222, 223, 255, 235};
	constexpr xdraw::color col_text_dim{184, 173, 255, 82};
	constexpr xdraw::color col_card{ 18, 18, 26, 255 };
	constexpr xdraw::color col_card_item{ 24, 24, 33, 255 };
