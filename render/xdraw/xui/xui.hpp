...
namespace xui {
	...
	struct style {
		...
		xdraw::color window_bg{ 14, 14, 20, 255 };
		xdraw::color window_border{ 35, 35, 55, 255 };
		xdraw::color child_bg{ 18, 18, 26, 255 };
		xdraw::color child_border{ 30, 30, 48, 255 };
		xdraw::color checkbox_bg{ 24, 24, 33, 255 };
		xdraw::color checkbox_border{ 55, 60, 95, 255 };
		xdraw::color checkbox_mark{ 107, 127, 212, 255 };
		xdraw::color checkbox_mark_icon{ 14, 14, 20, 255 };
		xdraw::color slider_track{ 24, 24, 33, 255 };
		xdraw::color slider_fill{ 107, 127, 212, 255 };
		xdraw::color button_bg{ 22, 22, 31, 255 };
		xdraw::color button_border{ 0, 0, 0, 0 };
		xdraw::color button_hovered{ 25, 25, 38, 255 };
		xdraw::color button_active{ 30, 30, 45, 255 };
		xdraw::color keybind_bg{ 18, 18, 26, 255 };
		xdraw::color keybind_border{ 30, 30, 48, 255 };
		xdraw::color keybind_waiting{ 107, 127, 212, 255 };
		xdraw::color combo_bg{ 24, 24, 33, 255 };
		xdraw::color combo_border{ 0, 0, 0, 0 };
		xdraw::color combo_arrow{ 180, 190, 235, 255 };
		xdraw::color combo_hovered{ 25, 25, 38, 255 };
		xdraw::color combo_popup_bg{ 14, 14, 20, 255 };
		xdraw::color combo_popup_border{ 0, 0, 0, 0 };
		xdraw::color combo_popup_item_hovered{ 24, 24, 33, 255 };
		xdraw::color combo_popup_item_selected{ 24, 24, 33, 255 };
		xdraw::color popup_bg{ 14, 14, 20, 255 };
		xdraw::color popup_border{ 0, 0, 0, 0 };
		xdraw::color picker_bg{ 18, 18, 26, 255 };
		xdraw::color picker_border{ 0, 0, 0, 0 };
		xdraw::color picker_popup_bg{ 14, 14, 20, 255 };
		xdraw::color picker_popup_border{ 0, 0, 0, 0 };
		xdraw::color text_input_bg{ 24, 24, 33, 255 };
		xdraw::color text_input_border{ 0, 0, 0, 0 };
		xdraw::color separator{ 107, 127, 212, 35 };
		xdraw::color text{ 200, 208, 240, 235 };
		xdraw::color text_dim{ 107, 127, 212, 90 };
		xdraw::color accent{ 107, 127, 212, 255 };
	};
